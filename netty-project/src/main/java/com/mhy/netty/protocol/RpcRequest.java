...
package com.mhy.netty.protocol;
import com.google.common.base.Objects;
import com.mhy.netty.buffer.ManagedBuffer;
import com.mhy.netty.buffer.NettyManagedBuffer;
import io.netty.buffer.ByteBuf;

/**
 * A generic RPC which is handled by a remote {@link server.RpcHandler}.
 * This will correspond to a single
 * {@link protocol.ResponseMessage} (either success or failure).
 */
